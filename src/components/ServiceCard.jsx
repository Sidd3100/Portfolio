...
const ServiceCard = ({count,text}) => {
  return <div className="w-full lg:w-52 h-32 rounded-md border border-[rgba(255,255,255,0.3)] flex items-center justify-center flex-col gap-2 group hover:border-primary cursor-pointer relative bg-bgPrimary" style = {{boxShadow:"inset 0 0 10px rgba(255,255,255,0.3"}}>
